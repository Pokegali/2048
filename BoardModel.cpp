...
QHash<int, QByteArray> BoardModel::roleNames() const
{
    static QHash<int, QByteArray> mapping{
        {BoardIndexRole, "index"}, {BoardValueRole, "value"}, {BoardToDeleteRole, "toDelete"}};
    return mapping;
}
...
{
    return static_cast<int>(std::find_if(this->tiles.begin(), this->tiles.end(),
                                         [&tileIndex, &toDelete](const Tile& tile)
